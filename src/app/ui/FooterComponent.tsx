...
const footerNavigation = {
  products: [
    { name: 'Bolsas', href: '/products' },
    { name: 'Tees', href: '/products' },
    { name: 'Objetos', href: '/products' },
    { name: 'Bens do Lar', href: '/products' },
    { name: 'Acessórios', href: '/products' },
  ],
  company: [
    { name: 'Quem somos', href: '/products' },
    { name: 'Sustentabilidade', href: '/products' },
    { name: 'Imprensa', href: '/products' },
    { name: 'Carreiras', href: '/products' },
    { name: 'Termos e condições', href: '/products' },
    { name: 'Privacidade', href: '/products' },
  ],
  customerService: [
    { name: 'Contato', href: '/products' },
    { name: 'Envio', href: '/products' },
    { name: 'Reembolso', href: '/products' },
    { name: 'Garantia', href: '/products' },
    { name: 'Pagamentos seguros', href: '/products' },
    { name: 'FAQ', href: '/products' },
    { name: 'Encontre uma loja', href: '/products' },
  ],
}
